  ...
  return (
    <div className="relative group">
      ...
      <Link href={`/stocks/${stock.symbol}`} className="block h-full">
        <Card className="h-full cursor-pointer transition-all hover:bg-secondary/80 border-0 bg-card shadow-sm dark:shadow-none">
          ...
          <CardContent>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed line-clamp-3 italic">
